...
public class BankAccountCreateBankAccountClient {
    ...
    private static void perform(BankAccountManager.Client bankAccountManagerClient) throws TException {
        ...
        BankAccount ba = bankAccountManagerClient.createBankAccount(name);
        System.out.println("created bank account:" + ba.toString());
    }
}
